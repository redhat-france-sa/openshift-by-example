...
oc new-app nodejs~https://github.com/redhat-france-sa/openshift-by-example.git --context-dir=/frontend --name frontend --labels='app.kubernetes.io/part-of=fruits-catalog,app.openshift.io/runtime=nodejs'
